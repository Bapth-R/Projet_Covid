 ...
 *             Nous pouvons aussi enregistrer les informations rentrées dans des fichiers afin de les sauvegarder même après l’arrêt de notre programme. \n \n
 * 
 * \b Image \b d'accueil
 ...
 * \brief                                                                                                                                                                   
 * 
 * \brief      Afin de simplifier le programme, je pourrai modifier la fonction permettant de rentrer la date choisissant de la date avec les flèches comme avec les citoyens et les lieux. 
 * 
 * 
 * 
*/
 ...
 * 
 * \brief                                                                                                                            
 * \brief  L’objectif de ce projet est de réaliser un programme en langage C étant capable de nous dire les différentes personnes que nous avons rencontré dans un délai de 7 jours. \n
 *         Pour cela, nous avons dû créer plusieurs structures nous permettant de pouvoir faire correspondre les différentes informations entre elles. C’est-à-dire pouvoir ajouter des \n
 *         personnes à un lieu à une date précise sans aucun problème. Nous avons été contraints d’enregistrer les informations saisis dans des fichiers afin de les sauvegarder. \n 
 *         Nous avons du aussi faire un programme qui les exploite afin de réexploiter nos sauvegardes. \n
 ...
 * \brief \n
 *      - Afin d'ajouter un Citoyen, il suffit de se rendre dans la partie d'ajout de citoyen puis de rentrer le nom. Afin de dire au programme que vous avez fini, \n
 *        il faut appuyer sur la touche entrer. C'est la même manière pour l'ajout du prénom. 
 * \brief \n
 ...
 * \brief \n
 *      - Afin de supprimer des fêtes trop anciennes, il suffit d'aller dans la catégorie en question (9) et de suivre les informations. Tous les événements ayant une date inférieure à la date rentrée seront supprimer.  
*/
 ...
 * \brief                                                                                                                           
 * 
 * \brief Afin de pouvoir avoir le nombre de cas de coronavirus, il faut modifier le fichier script_corona.bat en y remplacant le chemin absolu par le votre.
 * 
 * 
 * 
*/
 ...
 *        Cela m’a aussi permis de voir que pour faire des projets de programmation, il faut bien se pauser et se faire un plan clair et précis pour ne pas se perdre et devoir tout recommencer. \n
